...
BD_HISTORIAL$ETAPA[BD_HISTORIAL$PROC_ESTADO=="En revisión[Coordinador]"|BD_HISTORIAL$PROC_ESTADO=="Observado[Coordinador]"]="2) COORDINADOR"
BD_HISTORIAL$ETAPA[BD_HISTORIAL$PROC_ESTADO=="En revisión[Especialista CSIG]"|BD_HISTORIAL$PROC_ESTADO=="Observado[Especialista CSIG]"|BD_HISTORIAL$PROC_ESTADO=="Validado[Especialista CSIG]"]="3) ESPECIALISTA CSIG"

BD_HISTORIAL$PROC_ESTADO[BD_HISTORIAL$PROC_ESTADO=="Pendiente de revisión"]="PENDIENTE DE REVISION"
BD_HISTORIAL$PROC_ESTADO[BD_HISTORIAL$PROC_ESTADO=="En revisión[Coordinador]"]="EN REVISION"
BD_HISTORIAL$PROC_ESTADO[BD_HISTORIAL$PROC_ESTADO=="Observado[Coordinador]"]="OBSERVADO"
BD_HISTORIAL$PROC_ESTADO[BD_HISTORIAL$PROC_ESTADO=="En revisión[Especialista CSIG]"]="EN REVISION"
BD_HISTORIAL$PROC_ESTADO[BD_HISTORIAL$PROC_ESTADO=="Observado[Especialista CSIG]"]="OBSERVADO"
BD_HISTORIAL$PROC_ESTADO[BD_HISTORIAL$PROC_ESTADO=="Validado[Especialista CSIG]"]="VALIDADO"
